# Milestones: Pocket Monsters Black 2

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-Black2-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters Black 2 |
...
Coordinate Generation V sequel research with White 2 and compare against Black/White without treating them as layout-identical.
